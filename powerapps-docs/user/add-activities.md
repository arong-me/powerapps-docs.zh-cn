...
1. 在导航栏上，选择“加号”![创建记录按钮](media/create-record-button.png "“创建记录”按钮")，然后选择“活动”   。 
...
要在对话视图中列出电子邮件，请转到“设置” > “个性化设置” > “电子邮件”选项卡，然后选择“将电子邮件作为对话显示在时间线上”     。 有关个人设置的详细信息，请参阅[设置个人选项](https://docs.microsoft.com/powerapps/user/set-personal-options#email-tab-options)。 启用后，可以打开具有时间线的任何窗体，并且电子邮件将分组到对话线程中，最新的电子邮件显示在最上方。
...
添加备注后，可以删除或编辑备注。 选择备注或将光标悬停在备注上以查看编辑和删除图标。
...
在“时间线”留言板中，选中![更多按钮](media/MoreButton.png "“更多”按钮")，然后选择“刷新时间线”   。
