...
如果没有注册 Power Apps，请在开始之前[免费注册](https://make.powerapps.com/signup?redirect=marketing&email=)。
...
通过 [https://make.powerapps.com](https://make.powerapps.com?utm_source=padocs&utm_medium=linkinadoc&utm_campaign=referralsfromdoc) 登录 Power Apps。
...
* 仅支持以下音频格式：AAC、H264、OGG Vorbis 和 WAV。
...
在本主题中，你将产品展示示例应用添加到了 Teams 频道，然后从该频道打开了应用。 如需了解有关 Power Apps 的详细信息，请继续查看 Power Apps 教程。
