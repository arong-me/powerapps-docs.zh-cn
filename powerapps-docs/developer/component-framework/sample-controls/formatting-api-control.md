---
title: 格式化 API 组件 |Microsoft Docs
description: ''
keywords: ''
ms.author: nabuthuk
author: Nkrb
...
ms.locfileid: "72340428"
---
# <a name="implementing-formatting-api-component"></a>实现格式设置 API 组件

此示例组件将探讨作为 PowerApps 组件框架格式设置 API 的一部分提供的各种方法。 在此示例中，您将创建一系列输入元素，这些元素调用格式设置 API 的相应方法，该方法与显示的值匹配。

> [!div class="mx-imgBorder"]
> ![格式化 api]组件(../media/formatting-api.png "格式 api 组件")
