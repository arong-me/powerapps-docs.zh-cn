---
title: 在 PowerApps 中创建模型驱动应用程序的应用程序站点地图 | MicrosoftDocs
...
|站点地图|支持的客户端|  
|---------------|-----------------------|  
|新应用| 统一接口和 Dynamics 365 Customer Engagement Web 应用程序 |  
|Dynamics 365 - 自定义应用的站点地图 | Dynamics 365 customer engagement Web 应用程序和 Dynamics 365 for Outlook |  
|默认业务应用（Sales、销售中心、Customer Service、客户服务中心、Field Service、Project Service Automation）| Dynamics 365 Customer Engagement Web 应用程序和统一接口|  
