...
description: 了解在 PowerApps 中如何导入、更新和导出解决方案
ms.custom: ''
ms.date: 11/06/2018
ms.reviewer: ''
...
# <a name="import-update-and-export-solutions"></a>导入、更新和导出解决方案 
 ...
 可以使用以下步骤手动导入解决方案。 只能导入从受信任源获取的解决方案。 自定义项可能包含可向外部源发送数据的代码。 只能将名称为**默认解决方案**的解决方案导入从中导出该解决方案的环境，不能导入其他环境。  
...
## <a name="export-solutions"></a>导出解决方案  
 我们建议您定期导出您的非托管自定义项，以便拥有备份以备不时之需。 您无法导出托管解决方案。 可以从 PowerApps 导出解决方案，也可以使用经典体验导出。 
...
7.  下一步允许您为特定的 Dynamics 365 for Customer Engagement 版本选择目标解决方案。 那些可能要导出符合早期版本的解决方案的 ISV 通常使用此选项。 除非您要将该解决方案导入到未升级到与您所使用的环境版本相同的版本的环境中，否则接受默认即可。   
...
|日期格式代码|有关日期在整个 Dynamics 365 for Customer Engagement 中的显示方式的信息。|  
