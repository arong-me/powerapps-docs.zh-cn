...
1. 将详细信息库的**Items**属性设置为以下公式：
    ...
    > [!div class="mx-imgBorder"]
    > "订单" 实体与 "订单详细信息" 实体之间 ![一对多关系](media/northwind-orders-canvas-part3/schema-orders-rel.png)
...
1. 在详细信息库中，**从 "插入" 选项卡**中选择 "添加项" 以选择库模板：
    ...
    > [!div class="mx-imgBorder"]
    > ![为详细信息库选择模板](media/northwind-orders-canvas-part3/details-07.png)
...
1. 调整标签的大小，以显示完整的文本：
    ...
    > [!div class="mx-imgBorder"]
    > 订单详细信息实体与订单产品实体之间 ![多对一关系](media/northwind-orders-canvas-part3/schema-orderdetails-rel.png)

    提取 "**产品名称**" 字段（以及要使用的其他字段）：

    > [!div class="mx-imgBorder"]
    > 订单产品实体中 ![字段](media/northwind-orders-canvas-part3/schema-products-fields.png)
...
1. 减小库模板的高度，以便一次显示多个**订单详细信息**记录：
    ...
    > [!div class="mx-imgBorder"]
    > ![缩短库模板](media/northwind-orders-canvas-part3/details-13.png)
...
1. 在 "**主页**" 选项卡上，将此控件的对齐方式更改为**右**对齐：
    ...
    > [!div class="mx-imgBorder"]
    > ![更改对齐](media/northwind-orders-canvas-part3/details-14.png)
...
1. 在 "**主页**" 选项卡上，将此控件的对齐方式更改为**右**对齐：
    ...
    > [!div class="mx-imgBorder"]
    > ![更改对齐](media/northwind-orders-canvas-part3/details-16.png)
...
1. 在 "**主页**" 选项卡上，将此控件的对齐方式更改为**右**对齐：
    ...
    > [!div class="mx-imgBorder"]
    > ![更改对齐](media/northwind-orders-canvas-part3/details-18.png)
...
1. 双击标签的文本，然后键入**Product**：
    ...
    > [!div class="mx-imgBorder"]
    > ![将标签文本更改为 Product](media/northwind-orders-canvas-part3/details-20.png)
...
1. 将标题栏复制并粘贴到屏幕中间，然后将其复制到屏幕底部：
    ...
    > [!div class="mx-imgBorder"]
    > ![复制标题栏，并将副本移到底部边缘](media/northwind-orders-canvas-part3/sum-02.png)
...
1. 在 "**主页**" 选项卡上，将新标签的文本对齐方式设置为 "**右**"：
    ...
    > [!div class="mx-imgBorder"]
    > ![更改对齐](media/northwind-orders-canvas-part3/sum-04.png)
...
1. 在右侧边缘附近的 "**属性**" 选项卡中，向下滚动并关闭 "**允许多项选择**"，并确保已启用 "**允许搜索**"：
    ...
    > [!div class="mx-imgBorder"]
    > ![禁用多个选择并启用搜索](media/northwind-orders-canvas-part3/add-details-12.png)
...
1. 在 "**插入**" 选项卡上，选择 " **Media**  > "**图像**：
    ...
    > [!div class="mx-imgBorder"]
    > 图像控件 ![默认位置](media/northwind-orders-canvas-part3/add-details-16.png)
...
1. 在 "**插入**" 选项卡上，选择 "**文本**"  > **文本输入**：
    ...
    > [!div class="mx-imgBorder"]
    > 文本输入框 ![默认位置](media/northwind-orders-canvas-part3/add-details-19.png)
...
1. 在 "**主页**" 选项卡上，将此控件的文本对齐方式设置为 "**右**"：
    ...
    > [!div class="mx-imgBorder"]
    > ![更改对齐](media/northwind-orders-canvas-part3/add-details-22.png)
...
1. 在 "**主页**" 选项卡上，将列表价格标签的文本对齐方式设置为 "**右**"：
    ...
    > [!div class="mx-imgBorder"]
    > ![更改对齐](media/northwind-orders-canvas-part3/add-details-25.png)
...
1. 在 "**插入**" 选项卡上，选择 "**图标** > **添加**：
    ...
    > [!div class="mx-imgBorder"]
    > "添加" 图标 ![默认位置](media/northwind-orders-canvas-part3/add-details-30.png)
...
1. 按 F5，然后选择 "**添加**" 图标。
    ...
    > [!div class="mx-imgBorder"]
    > 添加订单详细信息的 ![动画](media/northwind-orders-canvas-part3/add-details.gif)
...
1. 在 "**插入**" 选项卡上，选择**图标** > **垃圾桶**：
    ...
    > [!div class="mx-imgBorder"]
    > 图标 ![默认位置](media/northwind-orders-canvas-part3/remove-details-03.png)
