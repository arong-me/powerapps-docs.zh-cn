...
4. 将每个 **[下拉](control-drop-down.md)** 控件的 **[Visible](properties-core.md)** 属性设置为以下值之一：
   ...
   * CarpetList**If （"地毯" CategoryList. SelectedItems，true）**
   * HardwoodList**If （"Hardwood" in SelectedItems，true）**
   * TileList**如果为（在 CategoryList 中为 "磁贴"，则为 true）**
