...
通过使用**颜色**枚举，可以轻松访问的 HTML 的级联样式表 (CSS) 定义的颜色。 例如， **Color.Red**返回纯红色。 您可以找到本主题末尾的这些颜色的列表。

**ColorValue**函数将返回基于 CSS 颜色字符串的颜色。 字符串可以采用上述任何窗体：

- **CSS 颜色名称：** **"RoxyBrown"** 并 **"OliveDrab"** 是示例。 这些名称不包含空格。 本主题后面显示的受支持的颜色列表。
- **6 位十六进制值：** 作为示例 **"#ffd700"** 等同于 **"黄金"** 。 字符串的格式"#*rrggbb*"其中*rr*是两个十六进制数字中的红色部分*gg*呈绿色，以及*bb*是蓝色的。
- **8 位十六进制值：** 例如， **"#ff7f5080"** 等同于 **"珊瑚红"** 与 50%的 alpha 通道。 字符串的格式"#*rrggbbaa*"其中*rr*， *gg*，以及*bb*等于 6 位数字窗体。 表示 alpha 通道*aa*:**00**表示完全透明的并**ff**表示完全不透明。

**RGBA**函数将返回基于红色、 绿色和蓝色分量的颜色。 该函数还包括混合前面另一个分层的控件的颜色的 alpha 通道。 Alpha 通道从 0 或 1 到 0%（这是完全透明且不可见） 或 100%（这是完全不透明，完全遮蔽了一个控件后面的任何图层） 各不相同。

**ColorFade** 函数返回更亮或更深的颜色版本。 淡入淡出量为 0 （这不会影响颜色） 变化从-1 (完全变暗为黑色） 到 1 （这使完全变亮为白色的颜色）。

## <a name="alpha-channel"></a>Alpha 通道

在画布应用中，可以层前面另一个控件，并指定到任何位于它的控件的控件的透明度。 因此，颜色将 blend 各个层。 例如下, 图显示了三种基本色，alpha 设置为 50%的混合使用：

> [!div class="mx-imgBorder"]
> ![Alpha 设置为 50%的三种基本色](media/function-colors/alpha-primary.png)

此外可以混合支持 alpha 通道的文件格式中的映像。 例如，您不能混合.jpeg 文件，但您可以在混合.png 文件。 下图显示了相同的红色，绿色和蓝色颜色从上一示例中，但红色颜色中将显示为波浪线 （而不是一个圆圈） 具有 50%的 alpha 通道的.png 文件：

> [!div class="mx-imgBorder"]
> ![Alpha 设置为蓝色和绿色圆圈的前面的 50%的红色波浪线](media/function-colors/alpha-image.png)

如果指定**颜色**枚举值，或生成**ColorValue**公式使用的颜色名称或 6 位十六进制值，alpha 设置为 100%，这是完全不透明。

## <a name="syntax"></a>语法

**Color**.*ColorName*

- *ColorName* - 必需。  级联样式表 (CSS) 颜色名称。 在本主题的最后阶段显示可能的枚举值的列表。

**ColorValue**(*CSSColor*)

- *CSSColor* - 必需。  级联样式表 (CSS) 颜色定义。 您可以指定的名称，如**OliveDrab**，或十六进制值，如 **#6b8e23**或 **#7fffd420**。 十六进制值可以采用以下形式的任一 #*rrggbb*或 #*rrggbbaa*。

**RGBA**(*Red*, *Green*, *Blue*, *Alpha*)

- *Red*、*Green*、*Blue* - 必需。  颜色组件值，范围从 0 （无饱和度） 到 255 （完全饱和度）。
- *Alpha* - 必需。  Alpha 组件，范围为 0 （完全透明） 到 1 （完全不透明）。 还可以使用百分比（0% 到 100%）。

**ColorFade**(*Color*, *FadeAmount*)

- *Color* - 必需。  颜色值（如 **Color.Red**），或者 **ColorValue** 或 **RGBA** 的输出。
- *FadeAmount* - 必需。  介于 -1 和 1 之间的数字。 -1 完全变暗为黑色，0 不会影响颜色，并且 1 完全使变亮为白色的颜色。 此外可以使用-100 的百分比为 100%%。
...
| **Color.Aqua** |**ColorValue( "#00ffff"&nbsp;)**<br>**ColorValue( "AQUA"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![浅绿色](./media/function-colors/color-aqua.png) |
| **Color.Aquamarine** |**ColorValue( "#7fffd4"&nbsp;)**<br>**ColorValue( "Aquamarine"&nbsp;)** |**RGBA(&nbsp;127,&nbsp;255,&nbsp;212,&nbsp;1&nbsp;)** |![水绿色](./media/function-colors/color-aquamarine.png) |
| **Color.Azure** |**ColorValue( "#f0ffff"&nbsp;)**<br>**ColorValue( "azure"&nbsp;)** |**RGBA(&nbsp;240,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![天蓝色](./media/function-colors/color-azure.png) |
| **Color.Beige** |**ColorValue( "#f5f5dc"&nbsp;)**<br>**ColorValue( "Beige"&nbsp;)** |**RGBA(&nbsp;245,&nbsp;245,&nbsp;220,&nbsp;1&nbsp;)** |![米黄色](./media/function-colors/color-beige.png) |
| **Color.Bisque** |**ColorValue( "#ffe4c4"&nbsp;)**<br>**ColorValue( "BISQUE"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;228,&nbsp;196,&nbsp;1&nbsp;)** |![橘黄色](./media/function-colors/color-bisque.png) |
| **Color.Black** |**ColorValue( "#000000"&nbsp;)**<br>**ColorValue( "Black"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;0,&nbsp;0,&nbsp;1&nbsp;)** |![黑色](./media/function-colors/color-black.png) |
...
| **Color.Brown** |**ColorValue ("#a52a2a"&nbsp;)**<br>**ColorValue( "Brown"&nbsp;)** |**RGBA(&nbsp;165,&nbsp;42,&nbsp;42,&nbsp;1&nbsp;)** |![棕色](./media/function-colors/color-brown.png) |
| **Color.Burlywood** |**ColorValue( "#deb887"&nbsp;)**<br>**ColorValue( "burlywood"&nbsp;)** |**RGBA(&nbsp;222,&nbsp;184,&nbsp;135,&nbsp;1&nbsp;)** |![实木色](./media/function-colors/color-burlywood.png) |
...
| **Color.Chocolate** |**ColorValue( "#d2691e"&nbsp;)**<br>**ColorValue( "Chocolate"&nbsp;)** |**RGBA(&nbsp;210,&nbsp;105,&nbsp;30,&nbsp;1&nbsp;)** |![巧克力色](./media/function-colors/color-chocolate.png) |
| **Color.Coral** |**ColorValue( "#ff7f50"&nbsp;)**<br>**ColorValue( "coral"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;127,&nbsp;80,&nbsp;1&nbsp;)** |![珊瑚色](./media/function-colors/color-coral.png) |
...
| **Color.Cyan** |**ColorValue( "#00ffff"&nbsp;)**<br>**ColorValue( "cyan"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![蓝绿色](./media/function-colors/color-cyan.png) |
...
| **Color.DarkGray** |**ColorValue ("#a9a9a9"&nbsp;)**<br>**ColorValue( "darkgray"&nbsp;)** |**RGBA(&nbsp;169,&nbsp;169,&nbsp;169,&nbsp;1&nbsp;)** |![深灰色](./media/function-colors/color-darkgray.png) |
...
| **Color.Gold** |**ColorValue ("#ffd700"&nbsp;)**<br>**ColorValue( "Gold"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;215,&nbsp;0,&nbsp;1&nbsp;)** |![金色](./media/function-colors/color-gold.png) |
| **Color.GoldenRod** |**ColorValue( "#daa520"&nbsp;)**<br>**ColorValue( "goldenrod"&nbsp;)** |**RGBA(&nbsp;218,&nbsp;165,&nbsp;32,&nbsp;1&nbsp;)** |![金麒麟色](./media/function-colors/color-goldenrod.png) |
| **Color.Gray** |**ColorValue( "#808080"&nbsp;)**<br>**ColorValue( "Gray"&nbsp;)** |**RGBA(&nbsp;128,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![灰色](./media/function-colors/color-gray.png) |
| **Color.Green** |**ColorValue( "#008000"&nbsp;)**<br>**ColorValue( "GREEN"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;128,&nbsp;0,&nbsp;1&nbsp;)** |![绿色](./media/function-colors/color-green.png) |
...
| **Color.Grey** |**ColorValue( "#808080"&nbsp;)**<br>**ColorValue( "grey"&nbsp;)** |**RGBA(&nbsp;128,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![灰色](./media/function-colors/color-grey.png) |
| **Color.Honeydew** |**ColorValue( "#f0fff0"&nbsp;)**<br>**ColorValue( "Honeydew"&nbsp;)** |**RGBA(&nbsp;240,&nbsp;255,&nbsp;240,&nbsp;1&nbsp;)** |![蜜色](./media/function-colors/color-honeydew.png) |
...
| **Color.Indigo** |**ColorValue( "#4b0082"&nbsp;)**<br>**ColorValue( "indigo"&nbsp;)** |**RGBA(&nbsp;75,&nbsp;0,&nbsp;130,&nbsp;1&nbsp;)** |![靛蓝色](./media/function-colors/color-indigo.png) |
| **Color.Ivory** |**ColorValue( "#fffff0"&nbsp;)**<br>**ColorValue( "Ivory"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;255,&nbsp;240,&nbsp;1&nbsp;)** |![乳白色](./media/function-colors/color-ivory.png) |
| **Color.Khaki** |**ColorValue( "#f0e68c"&nbsp;)**<br>**ColorValue( "KHAKI"&nbsp;)** |**RGBA(&nbsp;240,&nbsp;230,&nbsp;140,&nbsp;1&nbsp;)** |![卡其色](./media/function-colors/color-khaki.png) |
| **Color.Lavender** |**ColorValue( "#e6e6fa"&nbsp;)**<br>**ColorValue( "Lavender"&nbsp;)** |**RGBA(&nbsp;230,&nbsp;230,&nbsp;250,&nbsp;1&nbsp;)** |![淡紫色](./media/function-colors/color-lavender.png) |
...
| **Color.LightSeaGreen** |**ColorValue ("#20b2aa"&nbsp;)**<br>**ColorValue( "lightseagreen"&nbsp;)** |**RGBA(&nbsp;32,&nbsp;178,&nbsp;170,&nbsp;1&nbsp;)** |![浅海蓝色](./media/function-colors/color-lightseagreen.png) |
...
| **Color.Lime** |**ColorValue( "#00ff00"&nbsp;)**<br>**ColorValue( "LIME"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;255,&nbsp;0,&nbsp;1&nbsp;)** |![酸橙色](./media/function-colors/color-lime.png) |
...
| **Color.Magenta** |**ColorValue( "#ff00ff"&nbsp;)**<br>**ColorValue( "Magenta"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;0,&nbsp;255,&nbsp;1&nbsp;)** |![洋红色](./media/function-colors/color-magenta.png) |
| **Color.Maroon** |**ColorValue( "#800000"&nbsp;)**<br>**ColorValue( "MAROON"&nbsp;)** |**RGBA(&nbsp;128,&nbsp;0,&nbsp;0,&nbsp;1&nbsp;)** |![褐红色](./media/function-colors/color-maroon.png) |
...
| **Color.Navy** |**ColorValue( "#000080"&nbsp;)**<br>**ColorValue( "Navy"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;0,&nbsp;128,&nbsp;1&nbsp;)** |![深蓝色](./media/function-colors/color-navy.png) |
| **Color.OldLace** |**ColorValue( "#fdf5e6"&nbsp;)**<br>**ColorValue( "OLDLACE"&nbsp;)** |**RGBA(&nbsp;253,&nbsp;245,&nbsp;230,&nbsp;1&nbsp;)** |![老花色](./media/function-colors/color-oldlace.png) |
| **Color.Olive** |**ColorValue( "#808000"&nbsp;)**<br>**ColorValue( "Olive"&nbsp;)** |**RGBA(&nbsp;128,&nbsp;128,&nbsp;0,&nbsp;1&nbsp;)** |![橄榄色](./media/function-colors/color-olive.png) |
...
| **Color.Orange** |**ColorValue ("#ffa500"&nbsp;)**<br>**ColorValue( "Orange"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;165,&nbsp;0,&nbsp;1&nbsp;)** |![橙色](./media/function-colors/color-orange.png) |
| **Color.OrangeRed** |**ColorValue( "#ff4500"&nbsp;)**<br>**ColorValue( "ORANGERED"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;69,&nbsp;0,&nbsp;1&nbsp;)** |![橙红色](./media/function-colors/color-orangered.png) |
| **Color.Orchid** |**ColorValue( "#da70d6"&nbsp;)**<br>**ColorValue( "Orchid"&nbsp;)** |**RGBA(&nbsp;218,&nbsp;112,&nbsp;214,&nbsp;1&nbsp;)** |![兰花紫](./media/function-colors/color-orchid.png) |
...
| **Color.Peru** |**ColorValue( "#cd853f"&nbsp;)**<br>**ColorValue( "PERU"&nbsp;)** |**RGBA(&nbsp;205,&nbsp;133,&nbsp;63,&nbsp;1&nbsp;)** |![秘鲁棕色](./media/function-colors/color-peru.png) |
| **Color.Pink** |**ColorValue( "#ffc0cb"&nbsp;)**<br>**ColorValue( "Pink"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;192,&nbsp;203,&nbsp;1&nbsp;)** |![粉红色](./media/function-colors/color-pink.png) |
...
| **Color.Purple** |**ColorValue( "#800080"&nbsp;)**<br>**ColorValue( "PURPLE"&nbsp;)** |**RGBA(&nbsp;128,&nbsp;0,&nbsp;128,&nbsp;1&nbsp;)** |![紫色](./media/function-colors/color-purple.png) |
...
| **Color.Salmon** |**ColorValue( "#fa8072"&nbsp;)**<br>**ColorValue( "Salmon"&nbsp;)** |**RGBA(&nbsp;250,&nbsp;128,&nbsp;114,&nbsp;1&nbsp;)** |![鲑肉色](./media/function-colors/color-salmon.png) |
...
| **Color.Silver** |**ColorValue( "#c0c0c0"&nbsp;)**<br>**ColorValue( "silver"&nbsp;)** |**RGBA(&nbsp;192,&nbsp;192,&nbsp;192,&nbsp;1&nbsp;)** |![银色](./media/function-colors/color-silver.png) |
...
| **Color.SlateGray** |**ColorValue( "#708090"&nbsp;)**<br>**ColorValue( "SlateGray"&nbsp;)** |**RGBA(&nbsp;112,&nbsp;128,&nbsp;144,&nbsp;1&nbsp;)** |![石板灰色](./media/function-colors/color-slategray.png) |
...
| **Color.Snow** |**ColorValue( "#fffafa"&nbsp;)**<br>**ColorValue( "Snow"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;250,&nbsp;250,&nbsp;1&nbsp;)** |![雪白色](./media/function-colors/color-snow.png) |
...
| **Color.SteelBlue** |**ColorValue( "#4682b4"&nbsp;)**<br>**ColorValue( "SteelBlue"&nbsp;)** |**RGBA(&nbsp;70,&nbsp;130,&nbsp;180,&nbsp;1&nbsp;)** |![钢蓝色](./media/function-colors/color-steelblue.png) |
| **Color.Tan** |**ColorValue( "#d2b48c"&nbsp;)**<br>**ColorValue( "tan"&nbsp;)** |**RGBA(&nbsp;210,&nbsp;180,&nbsp;140,&nbsp;1&nbsp;)** |![棕褐色](./media/function-colors/color-tan.png) |
| **Color.Teal** |**ColorValue( "#008080"&nbsp;)**<br>**ColorValue( "Teal"&nbsp;)** |**RGBA(&nbsp;0,&nbsp;128,&nbsp;128,&nbsp;1&nbsp;)** |![水鸭色](./media/function-colors/color-teal.png) |
| **Color.Thistle** |**ColorValue( "#d8bfd8"&nbsp;)**<br>**ColorValue( "THISTLE"&nbsp;)** |**RGBA(&nbsp;216,&nbsp;191,&nbsp;216,&nbsp;1&nbsp;)** |![蓟色](./media/function-colors/color-thistle.png) |
| **Color.Tomato** |**ColorValue( "#ff6347"&nbsp;)**<br>**ColorValue( "Tomato"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;99,&nbsp;71,&nbsp;1&nbsp;)** |![番茄色](./media/function-colors/color-tomato.png) |
...
| **Color.Turquoise** |**ColorValue( "#40e0d0"&nbsp;)**<br>**ColorValue( "turquoise"&nbsp;)** |**RGBA(&nbsp;64,&nbsp;224,&nbsp;208,&nbsp;1&nbsp;)** |![宝石绿色](./media/function-colors/color-turquoise.png) |
| **Color.Violet** |**ColorValue( "#ee82ee"&nbsp;)**<br>**ColorValue( "Violet"&nbsp;)** |**RGBA(&nbsp;238,&nbsp;130,&nbsp;238,&nbsp;1&nbsp;)** |![紫罗兰色](./media/function-colors/color-violet.png) |
| **Color.Wheat** |**ColorValue( "#f5deb3"&nbsp;)**<br>**ColorValue( "WHEAT"&nbsp;)** |**RGBA(&nbsp;245,&nbsp;222,&nbsp;179,&nbsp;1&nbsp;)** |![小麦色](./media/function-colors/color-wheat.png) |
| **Color.White** |**ColorValue( "#ffffff"&nbsp;)**<br>**ColorValue( "White"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;255,&nbsp;255,&nbsp;1&nbsp;)** |![白色](./media/function-colors/color-white.png) |
| **Color.WhiteSmoke** |**ColorValue( "#f5f5f5"&nbsp;)**<br>**ColorValue( "whitesmoke"&nbsp;)** |**RGBA(&nbsp;245,&nbsp;245,&nbsp;245,&nbsp;1&nbsp;)** |![烟白色](./media/function-colors/color-whitesmoke.png) |
| **Color.Yellow** |**ColorValue( "#ffff00"&nbsp;)**<br>**ColorValue( "Yellow"&nbsp;)** |**RGBA(&nbsp;255,&nbsp;255,&nbsp;0,&nbsp;1&nbsp;)** |![黄色](./media/function-colors/color-yellow.png) |
