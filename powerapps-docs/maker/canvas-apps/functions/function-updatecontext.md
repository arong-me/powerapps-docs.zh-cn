...
description: Power Apps 中 UpdateContext 函数的参考信息（包括语法和示例）
author: gregli-msft
manager: kvivek
...
ms.locfileid: "74729892"
---
# <a name="updatecontext-function-in-power-apps"></a>Power Apps 中的 UpdateContext 函数
