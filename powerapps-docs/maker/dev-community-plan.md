...
* 使用超过 100 个[现成连接器](./canvas-apps/connections-list.md)或创建你自己的[自定义连接器](./canvas-apps/register-custom-api.md)，连接任意数据源。
...
* 导出在个人环境中创建的解决方案，并[在 AppSource 上列出它们](./canvas-apps/dev-appsource-test-drive.md)，以便客户可以体验。

## <a name="who-can-sign-up-for-the-powerapps-community-plan"></a>哪些人可以注册 PowerApps 社区计划？
所有拥有[工作或学校帐户](signup-for-powerapps.md#faq)的人都可以注册 PowerApps 社区计划。 不过，我们特别建议以下人群注册此计划：
