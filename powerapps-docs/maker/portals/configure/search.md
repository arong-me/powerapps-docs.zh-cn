...
2.  选择页面顶部工具栏上的**设置**图标，然后选择**高级设置**。

2.  转到**设置** > **自定义** > **自定义系统**。

    ![自定义系统](../media/customize-system.png "自定义系统")

3.  在自定义对话框中，在左侧导航窗格中转到**组件** > **实体** > **案例**。 

4.  展开**案例**实体，选择**视图**。

5.  从列表中选择**门户搜索**视图，并在视图编辑器中将其打开。

    ![案例视图](../media/case-view.png "案例视图")

6.  在视图编辑器中，选择**视图属性**。

    ![视图编辑器](../media/view-editor.png "视图编辑器")

7.  按照要求对该视图进行重命名。 确保新的名称中不包含“门户搜索”一词。
...
10. 按照[重新生成完整的搜索索引](#rebuild-full-search-index)部分所述重新生成完整的索引。
