...
提示：此方案的[下载包](https://aka.ms/o4ia0f)包括该应用的完成版 (project-details-app.msapp)。
...
4. 插入另一个按钮，属性如下：
   ...
   * “Text”属性的值为“"Update Details"”
     ...
     注意：虽然此按钮的标签为“更新详细信息”，但我们会先转到“ViewProjects”屏幕，以选择要更新的项目。
...
注意：虽然我们稍后将在应用中生成用于编辑项目的所有字段（包括经理字段）的页面，但我们认为生成这样的屏幕也很棒。
