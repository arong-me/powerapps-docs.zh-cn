在移动设备上安装并使用 [!INCLUDE[pn_fieldservice_mobile_app_long](pn-fieldservice-mobile-app-long.md)] 移动应用即表示用户同意将用户组织分派的 ID、最终用户分派的 ID 以及设备 ID 传输至 Microsoft 和 Resco.net, Inc.，用于提供这些服务并验证本软件是否获得适当许可。  
&nbsp;<br />
