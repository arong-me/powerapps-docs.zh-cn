若要使用 Microsoft Dynamics 365 for Outlook，您需要使用您的凭据（电子邮件地址和密码）进行登录。 您可以选择在本地保存此信息，以免在您每次打开 Outlook 时都提示您提供凭据。 如果您选择在本地保存此信息，Dynamics 365 for Outlook 会在每次您打开 Outlook 时自动连接到 Microsoft Dynamics 365 (online)。  
