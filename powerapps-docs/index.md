      ...
      <ul class="pivots">
         <li>
            ...
            <ul id="home">
                                 ...
                                 <div class="cardSize">
                                    <div class="cardPadding">
                                       <div class="card">
                                          ...
                                          <div class="cardText">
                                             <h3>学习目录</h3>
                                             <p>查找适合你身为 Power Apps 用户这一角色的在线培训、亲自研讨会和活动。</p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
               ...
               <li>
                  <a href="#user"><strong>我是应用用户</strong></a>
                  <ul id="user"
                     class="cardsF">
                     <li>
                        <div class="container">
                           <p>应用用户可在手机、平板电脑或 Web 浏览器中<a href="/powerapps/user">查找和运行</a>其自身创建或由他人创建的应用。</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">查找并运行应用</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/run-app-browser">在 Web 浏览器中</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/run-app-client">在移动设备中（画布应用）</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/run-app-client-model-driven">在移动设备上（模型驱动应用）</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/powerapps-web-part">在 SharePoint 上（画布应用）</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/open-app-embedded-in-teams">在 Microsoft Teams 中（画布应用）</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/app-source">通过 AppSource</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">使用模型驱动应用</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/unified-interface">统一接口</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/navigation">导航和基础知识</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/create-a-record">创建记录</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/search-records">搜索记录</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/import-data">从 Excel 导入数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/export-to-excel-online">将数据导出到 Excel</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/user/use-flows">使用 Flow 自动执行流程</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <li>
                  <a href="#maker"><strong>我是应用开发者</strong></a>
                  <ul id="maker"
                     class="cardsF">
                     <li>
                        <div class="container">
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">画布应用</h3>
                                    <hr/>
                                    <ul>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/getting-started">什么是画布应用？</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/open-and-run-a-sample-app">创建示例应用</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/data-platform-create-app-scratch">从零开始构建应用</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/connections-list">连接器</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-create-business-rule">应用业务逻辑</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/add-configure-controls">设计界面</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/working-with-formulas">配置应用功能</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/edit-app">管理应用</a></p>
                                       <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/share-app">共享应用</a></p>
                                    </ul>
                                 </div>
                              </div>
                           </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">模型驱动应用</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/model-driven-app-overview">什么是模型驱动应用？</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/build-first-model-driven-app">创建应用</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/model-driven-app-components">了解应用组件</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/create-design-forms">创建并设计应用窗体</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/guide-staff-through-common-tasks-processes">应用业务逻辑</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/create-edit-views">创建和管理应用视图</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/create-edit-system-chart">使用图表</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/create-edit-dashboards">使用仪表板</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/model-driven-apps/use-custom-controls-data-visualizations">使用自定义控件</a></p>
               ...
               <li>
                  <a href="#admin"><strong>我是管理员</strong></a>
                  <ul id="admin"
                     class="cardsF">
                     <li>
                        <div class="container">
               ...
               <li>
                  <a href="#developer"><strong>我是开发人员</strong></a>
                  <ul id="developer"
                     class="cardsF">
                     <li>
                        <div class="container">
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">扩展画布应用</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/register-custom-api">自定义连接器</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/embed-apps-dev">集成到网站和其他服务中</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/offline-apps">开发可脱机使用的应用</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/canvas-apps/dev-appsource-test-drive">在 AppSource 中测试应用</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">扩展模型驱动应用</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/customize-entity-forms">自定义实体窗体</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/customize-entity-views">自定义实体视图</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/use-fetchxml-construct-query">使用 FetchXML 查询数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/detect-duplicate-data-with-code">检测重复数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/optimistic-concurrency">使用乐观并发</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/best-practices/work-with-data">最佳做法</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/entity-metadata">实体元数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/entity-attribute-metadata">特性元数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/entity-relationship-metadata">实体关系元数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/best-practices/work-with-metadata">最佳做法</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/import-data">导入数据</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/data-export-service">数据导出服务</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/data-synchronization">数据同步</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://www.microsoft.com/download/details.aspx?id=57777">白皮书：使用解决方案实现 ALM</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/powerapps-cli">获取 Power Apps CLI</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/xrm-tooling/build-windows-client-applications-xrm-tools">使用 XRM 工具构建 Windows 客户端应用程序</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">参考</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/reference/about-entity-reference">实体参考</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/dynamics365/customer-engagement/web-api/about?view=dynamics-ce-odata-9">Web API 参考</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/dotnet/api/microsoft.crm.sdk?view=dynamics-general-ce-9">组织服务参考</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/clientapi/reference">客户端 API 参考</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">示例</h3>
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/webapi/quick-start-console-app-csharp">快速入门：Web API 示例</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/org-service/quick-start-org-service-console-app">快速入门：组织服务示例</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/clientapi/walkthrough-write-your-first-client-script">快速入门：客户端 API 示例</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/webapi/web-api-samples-csharp">Web API 示例</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/org-service/samples/convert-fax-task">组织服务示例</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
