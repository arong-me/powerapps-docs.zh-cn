...
* 网站访问：[PowerApps](https://web.powerapps.com)、[PowerApps 管理中心](https://admin.powerapps.com/)和 [Office 365 服务信任门户](https://servicetrust.microsoft.com/)
...
> *** 只有当资源所有者明确授予访问权限时，管理员才能从 [PowerApps](https://web.powerapps.com) 访问这些资源。 如果没有对管理员授予访问权限，则其需要利用 [PowerApps 管理员 PowerShell cdmlet](https://go.microsoft.com/fwlink/?linkid=871804)。
