...
- **使用 Common Data Service SDK 处理数据**：结合使用 Common Data Service SDK 和 Azure Functions，在 PowerApps 中扩展查询和数据管理功能。 [了解详细信息](https://aka.ms/whgr2w)
...
- **使用 Common Data Service SDK 在通用数据模型上生成应用程序**：通过连接 Common Data Service 中的客户数据，生成自定义应用或深化产品的数据集成。 [了解详细信息](https://aka.ms/eek20s)
